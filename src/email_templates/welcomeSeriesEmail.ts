        ...
        return {
          ...
          mainMessage: `
            <p style="font-size: 15px; color: #4B5563; line-height: 1.6;">
              Your journey to premium products at unbeatable value starts now! 
              We're thrilled to have you on board.
            </p>
            <div style="background-color: #F9FAFB; padding: 20px; border-radius: 12px; border: 1px solid #E5E7EB; margin: 20px 0;">
              <h4 style="color: #1F2937; margin: 0 0 10px; font-size: 13px; text-transform: uppercase; letter-spacing: 1px;">Here's what you can do next:</h4>
      ...
      case 3:
        return {
          ...
          mainMessage: `
            ...
            <div style="background-color: #FFF7ED; padding: 20px; border-radius: 12px; border: 1px solid #FED7AA; margin: 20px 0;">
      ...
      case 7:
        return {
          ...
          mainMessage: `
            ...
            <div style="background-color: #F0FDF4; padding: 20px; border-radius: 12px; border-left: 4px solid #16A34A; margin: 20px 0;">
              <p style="margin: 0; font-size: 15px; color: #14532D; font-weight: bold;">
                🎉 Use code: <span style="font-family: monospace; background: #E5E7EB; padding: 4px 8px; border-radius: 4px;">WELCOME10</span> 
