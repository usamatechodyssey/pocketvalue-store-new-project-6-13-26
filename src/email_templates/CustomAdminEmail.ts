...
export const createCustomAdminEmailHtml = (data: CustomEmailProps): string => {
  ...
  const bodyHtml = `
    <div style="margin-bottom: 25px;">
        <p style="font-size: 16px; color: #1F2937;" class="dark-text">Assalamu Alaikum <strong>${data.customerName}</strong>,</p>
    </div>

    <!-- 📝 THE PERSONALIZED MESSAGE BODY -->
    <!-- ✅ DARK MODE SUPPORTED MESSAGE BOX -->
    <div style="background-color: #ffffff; padding: 25px; border: 1px solid #E5E7EB; border-radius: 16px; min-height: 150px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.02);" class="dark-card dark-border">
        <div style="font-size: 15px; color: #4B5563; line-height: 1.8; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;" class="dark-text">
            ${formattedMessage}
        </div>
    </div>
    ...
    <div style="margin-top: 35px; padding-top: 20px; border-top: 1px solid #F3F4F6;" class="dark-border">
        ...
        <!-- ✅ ACCENT SYNC: Updated signature brand title to exact brand warm orange (#FF8F32) -->
        ...
        <p style="margin: 5px 0 0; font-size: 12px; color: #9CA3AF; font-style: italic;" class="dark-subtext">
            Your Pocket. Our Value.
        </p>
    </div>

    <div style="margin-top: 40px; text-align: center;">
        <a href="${process.env.NEXT_PUBLIC_BASE_URL}" style="text-decoration: none; color: #9CA3AF; font-size: 11px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px;" class="dark-subtext">
