          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b dark:border-gray-800 shrink-0">
              ...
              <button
                ...
                className="p-2.5 rounded-full bg-gray-50 dark:bg-gray-800 text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
              >
            ...
            <div className="grow overflow-y-auto px-6 pb-20 custom-scrollbar">
              <div className="space-y-10">
                  ...
                  <section>
                    <div className="flex justify-between items-end mb-4">
                      <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest flex items-center gap-2">
                        <History size={12} aria-hidden="true" /> Your Recent
                        History
                      </h3>
                      <button
                ...
                {trendingKeywords?.length > 0 && (
                  <section>
                    <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                      <TrendingUp size={12} aria-hidden="true" /> Popular Right
                      Now
                    </h3>
                    <div className="flex flex-wrap gap-2">
                ...
                {popularCategories?.length > 0 && (
                  <section>
                    <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                      <Tag size={12} aria-hidden="true" /> Shop by Category
                    </h3>
