// // 📂 src/app/features/admin/traffic-attribution/components/TrafficSourceChart.tsx (DOM STACKING ORDER & TEXT MIXUP FIXED)
...
//     return (
//       <div className="bg-zinc-950 dark:bg-black border border-zinc-800 p-4 rounded-2xl shadow-2xl z-50 min-w-56 animate-in fade-in duration-100">
...
//             <span className="font-mono font-black text-white">Rs. {item.value.toLocaleString('en-PK')}</span>
//           </div>
//           <div className="flex justify-between items-center text-xs">
//             <span className="text-zinc-500 font-bold">Total Orders:</span>
//             <span className="font-mono font-bold text-zinc-300">{item.orders} Orders</span>
//           </div>
//         </div>
//       </div>
//     );
...
//         <div className="mb-4">
//           <h3 className="text-lg font-black text-zinc-900 dark:text-white uppercase tracking-tighter flex items-center gap-2 italic">
//             <Share2 size={20} className="text-brand-primary" /> Attribution Audit
//           </h3>
//           <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium italic mt-0.5">
//             Revenue Share by Traffic Channel
//           </p>
//         </div>
//         <div className="flex-1 flex flex-col items-center justify-center gap-4 py-8 text-center">
//           <div className="w-16 h-16 bg-zinc-100 dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 flex items-center justify-center">
//             <BarChart3 size={28} className="text-zinc-400 dark:text-zinc-600" />
//           </div>
//           <div>
//             <p className="text-xs font-black text-zinc-700 dark:text-zinc-300 uppercase tracking-widest">No Traffic Data</p>
//             <p className="text-[10px] text-zinc-400 font-medium mt-1">No attributed orders found for this timeframe.</p>
//           </div>
//         </div>
//         <div className="mt-auto pt-4 border-t border-zinc-200 dark:border-zinc-800/80">
//           <Link
//             href="/admin/marketing-hub"
//             className="w-full py-3 bg-zinc-50 dark:bg-zinc-900/60 rounded-xl border border-zinc-200 dark:border-zinc-800 flex justify-center items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-600 dark:text-zinc-400 hover:text-brand-primary hover:border-brand-primary/30 transition-all shadow-sm"
//           >
...
//         {/* ✅ FIXED: Central Donut Overlay PAINTED FIRST (Background Layer) */}
//         <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none text-center z-0">
//           <span className="text-[8px] font-black text-zinc-400 uppercase tracking-widest">Total Sales</span>
...
//         {/* ✅ FIXED: ResponsiveContainer PAINTED SECOND (Foreground Layer - Tooltip renders on top of Center Text) */}
...
//       {/* HIGH-DENSITY CHANNEL BREAKDOWN LIST */}
//       <div className="space-y-2.5 my-4 flex-1">
//         {sortedData.slice(0, 4).map((item, idx) => {
//           const share = totalRevenue > 0 ? ((item.value / totalRevenue) * 100).toFixed(0) : "0";
//           return (
//             <div
//               key={idx}
//               className="p-2.5 bg-zinc-50 dark:bg-zinc-900/50 rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 flex items-center justify-between gap-3 text-xs"
//             >
//               <div className="flex items-center gap-2.5 min-w-0">
//                 <span className="w-2.5 h-2.5 rounded-full shrink-0" style={{ backgroundColor: item.fill }} />
//                 <span className="font-black text-zinc-800 dark:text-zinc-200 uppercase tracking-wider text-[10px] truncate">
//                   {item.name}
//                 </span>
//               </div>
//               <div className="flex items-center gap-3 shrink-0">
//                 <span className="text-[9px] font-mono text-zinc-400 font-bold">{item.orders} Orders</span>
//                 <span className="font-mono font-black text-zinc-900 dark:text-white text-xs">
//                   Rs. {item.value.toLocaleString('en-PK')} ({share}%)
//                 </span>
//               </div>
//             </div>
//           );
