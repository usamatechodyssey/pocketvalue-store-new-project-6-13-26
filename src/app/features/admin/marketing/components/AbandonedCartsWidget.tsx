...
//   CheckCircle,
//   Users,
//   Banknote, // ✅ Replaced generic icon with Banknote for Lost Sales
// } from "lucide-react";
...
//   if (hours >= 48) return { label: "48h+", className: "text-red-500 bg-red-500/10" };
//   if (hours >= 24) return { label: "24h+", className: "text-amber-500 bg-amber-500/10" };
//   if (hours >= 6) return { label: "6h+", className: "text-yellow-500 bg-yellow-500/10" };
//   return { label: "2h+", className: "text-blue-500 bg-blue-500/10" };
// };
...
//     return (
//       <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800/80 rounded-[2.5rem] p-10 text-center shadow-2xl">
...
//             Great! All carts have been recovered or are still active in live sessions.
//           </p>
//         </div>
//       </div>
//     );
...
//         <div className="flex items-center gap-3">
//           <h3 className="text-lg font-black dark:text-white uppercase tracking-tighter italic">
//             Recover Carts Pipeline
//           </h3>
...
//       {/* 5-CARD MATRIX (Includes Total Lost Revenue PKR) */}
//       <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
//         <StatsCard
//           title="Total Lost Sales"
//           value={formatCurrency(data.summary.totalAbandonedRevenue || 0)} // ✅ Global Lost PKR Sales Sum
//           icon={Banknote} // ✅ PKR Banknote Icon
//           color="brand"
//           subtext="Unrecovered Lost Sales"
//         />
//         <StatsCard
...
//               <Mail size={14} />
//             )}
//             {isSending ? "Sending..." : "Send Bulk Recovery Email"}
//           </button>
//         </div>
//       )}
...
//                   Customer
//                 </th>
//                 <th className="py-3 px-4 text-right text-[10px] uppercase text-zinc-400 dark:text-zinc-500 font-bold tracking-wider">
//                   Subtotal
//                 </th>
...
//                     </td>
//                     <td className="py-3 px-4 text-center font-mono font-medium text-zinc-600 dark:text-zinc-400">
//                       {cart.itemsCount}
//                     </td>
//                     <td className="py-3 px-4 text-center">
//                       <span
//                         className={`px-2.5 py-0.5 rounded-full text-[9px] font-bold ${age.className}`}
//                       >
//                         {age.label}
//                       </span>
//                     </td>
...
//                         </span>
//                       ) : cart.email ? (
//                         <span className="text-blue-500 text-[10px] font-semibold bg-blue-500/10 px-2.5 py-0.5 rounded-full border border-blue-500/20">
//                           Pending
//                         </span>
//                       ) : (
//                         <span className="text-zinc-400 dark:text-zinc-600 text-[10px]">No email</span>
//                       )}
//                     </td>
//                     <td className="py-3 px-4 text-center">
