  ...
  return (
    <>
      ...
      <main className="w-full bg-gray-50 dark:bg-gray-950 pb-20">
        ...
        {relatedProducts && relatedProducts.length > 0 && (
          /* ✅ BACKGROUND SYNC FIX: Changed dark:bg-gray-900 to dark:bg-gray-950 so ProductCarousel background merges seamlessly! */
          <div
            className="mt-12 pt-8 w-full border-t border-zinc-200/60 dark:border-zinc-800/80"
            aria-label="Related products"
            role="region"
          >
            <ProductSectionWithBanner
