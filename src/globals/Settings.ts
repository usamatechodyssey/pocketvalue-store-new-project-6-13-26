...
// ================================================================
// 📋 COMMON ROLES CONFIGURATION (Multi-Platform Synced)
// ================================================================
const COMMUNICATION_ROLES_OPTIONS = [
  { label: "Order Confirmation", value: "order_confirmation" },
  { label: "Password Reset", value: "password_reset" },
  { label: "Marketing Campaign Broadcast", value: "marketing" },
  { label: "COD OTP Authentication", value: "cod_otp" },
  { label: "Tracking Updates", value: "tracking_update" },
  { label: "Invoice Delivery", value: "invoice_delivery" },
  { label: "Abandoned Cart Recovery", value: "abandoned_cart" },
  { label: "Customer Requests (Restocks / Sourcing)", value: "customer_requests" }, // ✅ 🆕 Added Dedicated Role option!
];
              ...
              fields: [
                {
                  ...
                  fields: [
                    { name: "enabled", type: "checkbox", defaultValue: true },
                    {
                      ...
                      type: "select",
                      hasMany: true,
                      options: COMMUNICATION_ROLES_OPTIONS, // ✅ 🆕 Direct dynamic array binding (No duplicate hardcodings)
                      defaultValue: ["order_confirmation", "password_reset", "cod_otp", "tracking_update", "invoice_delivery"],
                    },
                  ],
                },
                {
                  ...
                  fields: [
                    { name: "enabled", type: "checkbox", defaultValue: false },
                    {
                      ...
                      type: "select",
                      hasMany: true,
                      options: COMMUNICATION_ROLES_OPTIONS, // ✅ 🆕 Direct dynamic array binding
                      defaultValue: [],
                    },
                  ],
                },
