...
// 📂 src/models/Order.ts (DUAL PROFIT MODEL LOCKED & HARDENED FOR PRODUCTION)
...
interface IOrderProduct extends Omit<CleanCartItem, "image"> {
  ...
  targetProfit?: number; // ✅ NEW: Target Line Profit BEFORE Coupon Discounts (e.g. Rs. 2,000)
  ...
  // ✅ SNAPSHOT RATES (AUDIT TRAIL LOGIC)
  ...
  appliedRtoRate?: number;     // Snapshotted RTO Estimation %
}
...
const OrderProductSchema = new Schema<IOrderProduct>(
  {
    ...
    targetProfit: { type: Number, default: 0 }, // ✅ NEW: Frozen Target Profit BEFORE Coupon
    profit: { type: Number, default: 0 },       // Realized Pure Profit AFTER Coupon
    ...
    appliedRtoRate: { type: Number, default: 0 } 
  },
  { _id: false }
);
